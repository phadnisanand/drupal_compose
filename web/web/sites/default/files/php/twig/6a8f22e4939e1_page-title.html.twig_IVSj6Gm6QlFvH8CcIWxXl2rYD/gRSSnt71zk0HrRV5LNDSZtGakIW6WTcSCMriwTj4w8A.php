...
class __TwigTemplate_a08f2f11925033f89f33d0594659932f extends Template
{
...
";
        ...
        if ((!Twig\Extension\CoreExtension::testEmpty(Twig\Extension\CoreExtension::trim(Twig\Extension\CoreExtension::striptags($this->extensions['Drupal\Core\Template\TwigExtension']->renderVar(($context["title"] ?? null))))))) {
            // line 24
            yield "  <h1";
            yield (string) $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, ($context["title_attributes"] ?? null), "addClass", [($context["classes"] ?? null)], "method", false, false, true, 24), "html", null, true);
            yield ">";
...
";
    ...
    {
        return new Source("", "core/themes/olivero/templates/content/page-title.html.twig", "/opt/drupal/web/web/core/themes/olivero/templates/content/page-title.html.twig");
    }
    ...
    public function checkSecurity()
    {
        ...
        try {
            $this->sandbox->checkSecurity(
                [0 => "set", 1 => "if"],
                [0 => "escape", 1 => "trim", 2 => "striptags", 3 => "render"],
                [],
                [],
                $this->source
            );
