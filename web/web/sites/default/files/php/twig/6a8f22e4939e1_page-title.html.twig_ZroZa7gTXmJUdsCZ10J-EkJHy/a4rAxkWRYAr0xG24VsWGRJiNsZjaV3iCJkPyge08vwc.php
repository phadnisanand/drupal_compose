...
class __TwigTemplate_dd7535a40d75319b7f669478d8af66bb extends Template
{
...
";
        ...
        if ((($tmp = ($context["title"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 17
            yield "  <h1";
            yield (string) $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, ($context["title_attributes"] ?? null), "addClass", ["page-title"], "method", false, false, true, 17), "html", null, true);
            yield ">";
...
";
    ...
    {
        return new Source("", "core/themes/claro/templates/classy/content/page-title.html.twig", "/opt/drupal/web/web/core/themes/claro/templates/classy/content/page-title.html.twig");
    }
